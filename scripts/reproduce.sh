...
cd "$ROOT"
for model in Kev06B-fp32 Kev06B-fp16 Kev06B-Q4-fp32 Kev06B-Q4-fp16 Kev06B-L1024-Q4K96-fp16; do
  echo "--- $model ---"
...
"$ROOT/.build/release/jev" \
  --model "$ROOT/Models/Kev06B-Q4-fp16.mlpackage" --tokenizer "$ROOT/Models/tokenizer.json" \
  --serve --port 8008 &
SERVER=$!
...
echo
echo "fertig. Demo:"
echo "  ./.build/release/jev --model Models/Kev06B-Q4-fp16.mlpackage \\"
echo "     --tokenizer Models/tokenizer.json --demo --repeat 15"
